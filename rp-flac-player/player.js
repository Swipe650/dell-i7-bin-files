...
#var flacApiBaseUrl = 'https://api.radioparadise.com/api/get_block?bitrate=4&chan=2&info=true';
#var flacApiNextEventUrl = 'https://api.radioparadise.com/api/get_block?bitrate=4&chan=2&info=true';
